...
class RepositoryIf {
  public:
    ...
    virtual std::optional<ReminderApp::Core::Model::Reminder> postReminder(int listId, std::string title, std::string date, bool flagged) = 0;
    virtual std::optional<ReminderApp::Core::Model::Reminder> putReminder(int listId, int reminderId, std::string title, std::string date, bool flagged) = 0;
